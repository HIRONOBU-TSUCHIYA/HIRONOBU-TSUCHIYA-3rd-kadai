...
$("#send").on("click", function () {
    ...
    if (check1.includes("2") && check2.includes("3") && check3.includes("5")) {
        console.log("経営幹部");
        result = "経営幹部";
        judgment = '<img src="img/top-1.png">';
    } else if (check1.includes("2") && check2.includes("3") && check3.includes("6")) {
        console.log("長距離運転手");
        result = "長距離運転手";
    ...
    console.log("大型車");
    result = "大型フルサイズ";
    judgment = '<img src="img/oogata-1.jpg">';
    } else if (random === 3) {
    console.log("２ｔ車");
    result = "２ｔ車";
    judgment = '<img src="img/2t-1.jpg">';
    }else if (random === 4) {
    console.log("ベンツ");
    result = "ベンツ";
